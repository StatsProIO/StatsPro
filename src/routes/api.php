...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/events/latest/{domainName}/{visitorId}', [EventsController::class, 'getLatestEventByDomainAndVisitorId']);
    ...
    Route::get('/replay/{domainName}/{visitorId}', [ReplaysController::class, 'getReplay']);

});

Route::post('/replay/{domainName}', [ReplaysController::class, 'postReplay']);
