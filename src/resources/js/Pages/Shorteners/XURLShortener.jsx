...
export default function XURLShortener() {

    const faqBox = (
        <Box style={{borderColor: '#dddddd', borderWidth: '1px', borderStyle: 'solid', borderRadius: '5px', backgroundColor: 'white'}} p={6} m={6}>

            <Typography variant="h5" align={'center'}>What is the X Link Shortener?</Typography>

            <Typography variant="body1">This X link shortener is a tool specifically designed to shorten URLs that lead to X pages or are used on X. This tool takes long, complex X URLs and condense them into shorter, more manageable links.</Typography>

            <Typography variant="h5" align={'center'} sx={{pt: 2}}>Why use the X Link Shortener?</Typography>
            <Typography variant="body1">
                <ul>
                    <li>Space-saving: Shortened links take up less space, which can be especially useful for platforms with character limits like X or SMS.</li>
                    ...
                    <li>Affiliate marketing: If you're a X affiliate, using a link shortener can help cloak your affiliate links, making them look more natural and increasing the likelihood of clicks. Additionally, some link shorteners offer features specifically tailored for affiliate marketers, such as link rotation or A/B testing.</li>
                ...
                Using a link shortener for X links can help optimize your marketing efforts, improve user experience, and provide valuable insights into your audience's behavior.
            </Typography>
    ...
    return (
        <GenericURLShortener serviceTitle={'X'} icon={'https://twitter.com/'} faqBox={faqBox}/>
    );
}
