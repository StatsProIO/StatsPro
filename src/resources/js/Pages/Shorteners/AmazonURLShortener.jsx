...
export default function AmazonToolURLShortener() {

    const faqBox = (
        <Box style={{borderColor: '#dddddd', borderWidth: '1px', borderStyle: 'solid', borderRadius: '5px', backgroundColor: 'white'}} p={6} m={6}>

            <Typography variant="h5" align={'center'}>What is the Amazon Link Shortener?</Typography>

            <Typography variant="body1">An Amazon link shortener is a tool specifically designed to shorten URLs that lead to Amazon product pages. This tool takes long, complex Amazon URLs and condense them into shorter, more manageable links.</Typography>

            <Typography variant="h5" align={'center'} sx={{pt: 2}}>Why use the Amazon Link Shortener?</Typography>
            <Typography variant="body1">
                <ul>
                    ...
                    <li>Affiliate marketing: If you're an Amazon affiliate, using a link shortener can help cloak your affiliate links, making them look more natural and increasing the likelihood of clicks. Additionally, some link shorteners offer features specifically tailored for affiliate marketers, such as link rotation or A/B testing.</li>
                ...
                Using a link shortener for Amazon links can help optimize your marketing efforts, improve user experience, and provide valuable insights into your audience's behavior.
            </Typography>
    ...
    return (
        <GenericURLShortener serviceTitle={'Amazon'} icon={'https://amazon.com'} faqBox={faqBox}/>
    );
}
