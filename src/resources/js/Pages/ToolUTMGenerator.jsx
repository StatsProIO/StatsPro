    ...
    return (
        <General title={'UTM Generator'}>
            <Paper elevation={0} sx={{ mt: 1,  p: 2 }}>
                ...
                <Typography sx={{py: 1, wordBreak: 'break-word'}}>https://example.com/?utm_source=facebook&utm_medium=cpc&utm_campaign=holiday_sale&utm_term=keyword&utm_content=variant1</Typography>
