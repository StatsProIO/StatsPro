    ...
    return (
        <BlogLayout title={'Free Privacy Friendly Analytics'}>
            ...
            <Typography sx={{py: 1}}>
                ...
                Fortunately, there are ethical ways to keep your user's data private while still being able to capture information about your website visitors for free. One option is to use a privacy-friendly analytics service like StatsPro. <br/><br/>

                StatsPro is open-source software that you can add to your website and only collects the bare minimum to track core website metrics without invading your user's privacy. Best of all StatsPro is free to use for up to 5000 events! This means if you have a small or medium website, you can use StatsPro for free for as long as you'd like. All users of StatsPro enjoy the same privacy protections. Paid plans are available for larger websites with more traffic. <br/><br/>
            ...
            <Typography sx={{py: 1}}>
                ...
                There are a few different companies that offer privacy-friendly analytics, but our recommendation is StatsPro. StatsPro is an open-source analytics platform that is built from the ground up to be privacy friendly. It does not collect any personally identifiable information and does not track you across the web. In fact, StatsPro is willing to stand by its claim by <a href={'https://github.com/statsProIO/StatsPro/'}>open-sourcing all of the code</a> used to run the site. You can take a look to see exactly what data is being collected without even installing the code on your site.<br/><br/>
            </Typography>
