...
export default function DocsAbout() {
    return (
        <DocsLayout title={'About'}>
            ...
            <Typography sx={{py: 1}}>StatsPro goes beyond industry-standard protections for user privacy. Other privacy-friendly analytics platforms will hash IP addresses or other user information in a process called "fingerprinting". This fingerprinting is illegal under PECR (the UK’s privacy directive). </Typography>
