...
export function DashboardInfoCard({ title, value, subtitleValue, subtitleText }) {
    ...
    return <>
        <Paper elevation={0} sx={{ p: 2 }}>
            ...
            <Box sx={{ backgroundColor: subtitleValue < 0 ? 'rgba(244, 67, 54, 0.1)' : 'rgba(76, 175, 80, 0.1)', color: subtitleValue < 0 ? 'rgb(244, 67, 54)' : 'rgb(76, 175, 80)', fontWeight: 'bold', p: 1, borderRadius: '5px', display: 'inline' }}>
