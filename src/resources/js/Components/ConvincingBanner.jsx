            ...
            <Grid item xs={12} sx={{backgroundColor: '#334a71'}}>
                <Grid container justifyContent={"center"} sx={{py: 3}}>
                    <Grid item lg={6} md={11} xs={12} sx={{color: '#fff', px: 1}}>
                        <Typography variant={'h4'} fontWeight={'bold'}>The easiest analytics you've ever used.</Typography>
                        <Typography variant={'h6'}>No cookie banner. No technical jargon.</Typography>

                        <Button onClick={() => Inertia.get('/register')} variant="contained" size="large" style={{fontSize: '1.1em'}} endIcon={<ArrowForwardIosIcon />}
                                sx={{px: 2, py: 1, my: 2}} fontWeight="bold"><b>Start today. No credit card required.</b></Button>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
